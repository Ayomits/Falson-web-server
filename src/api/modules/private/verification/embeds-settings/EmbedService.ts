...
import { AuthorDto, EmbedDto, FooterDto } from './EmbedDto';
import { Cache } from '@nestjs/cache-manager';
import { defaultEmbeds, GuildType, SchemasName } from 'src/api/types';
import { Embed as EmbedModel } from './EmbedSchema';
import { GuildSettingsService } from '../../guild-settings/GuildSettingsService';
import { validateProperties } from 'src/api/utils';
